...
(21, '2024-05-01', 0.25, 200, 2, 3, 1),
(22, '2024-10-07', 0.25, 200, 1, 1, 1),
(24, '2024-10-13', 1.84, 100, 1, 10, 1),
(25, '2024-10-13', 1.62, 500, 1, 10, 1),
(26, '2024-10-13', 1.29, 2400, 1, 10, 1),
(28, '2024-10-13', 1.74, 4800, 1, 10, 1),
(29, '2024-10-13', 1.74, 100, 1, 10, 1),
(30, '2024-10-13', 1.06, 5090, 1, 10, 1),
(31, '2024-10-13', 1.36, 2200, 1, 10, 1);
...
(1, 'speedster01', 'hashed_password1', 2800, 'speedster01@example.com', '2024-01-15', 1),
...
(11, 'user', 'user', 999, 'user@user.ja', '2024-10-03', 0),
(12, 'userTeszt', 'envagyokaz', 100, 'nemnem@nem.szuper', '2024-10-03', 1),
(13, 'admin', 'adminadmin', 174823, 'admin@admin.ca', '2024-10-13', 1),
(14, 'organizer', 'org', 999999, 'org@org.ahga', '2024-10-13', 1);
...
(1, 'Bahrein Grand Prix', '2024-12-12', 'Race', 'Bahrain International Circuit, Bahrein'),
...
--
ALTER TABLE `bets`
  MODIFY `BetsID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=32;

--
-- AUTO_INCREMENT a táblához `bettors`
--
ALTER TABLE `bettors`
  MODIFY `BettorsID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;
